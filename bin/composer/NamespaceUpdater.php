...
namespace BitApps\Pi\ComposerScripts;
...
final class NamespaceUpdater
{
    ...
    public static function runStrauss()
    {
        ...
        if (self::$event->isDevMode()) {
            ...
            self::$event->getIO()->write(shell_exec('composer strauss'));
            self::$event->getIO()->write(shell_exec('composer dump-autoload'));
        } else {
            ...
            self::$event->getIO()->write(shell_exec('strauss'));
            self::$event->getIO()->write(shell_exec('composer dump-autoload'));
