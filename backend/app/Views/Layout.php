...
final class Layout
{
    ...
    public function head($currentScreen)
    {
        ...
        if (Config::isDev()) {
            wp_enqueue_script($slug . '-vite-client-helper-MODULE', Config::get('DEV_URL') . '/config/devHotModule.js', [], null);
            wp_enqueue_script($slug . '-vite-client-MODULE', Config::get('DEV_URL') . '/@vite/client', [], null);
            wp_enqueue_script($slug . '-index-MODULE', Config::get('DEV_URL') . '/main.tsx', [], null);
        } else {
