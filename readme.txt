...
Create AI-powered automation workflows on a visual canvas. Build unlimited tasks, workflows, and multi-step integrations with drag and drop.
...
Bit Flows connects to third-party services only when a site admin configures and runs those integrations in a workflow.
This may include AI providers, messaging APIs, and Google APIs depending on the nodes used in your flow.

Detailed external service disclosure (what is sent, when, terms, and privacy links):
